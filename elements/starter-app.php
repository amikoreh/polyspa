<?php
	...
	$menu_items_pages = polyspa_get_menu_items( $menu_name ); // see functions.php
?>
			...
			<app-drawer id="drawer" slot="drawer">
				...
				<?php if ( isset( $search_enabled ) && '1' === $search_enabled ) : ?>
					...
					<div id="searchcontainer">
						<paper-input label="<?php _e( 'Search', 'polyspa' ); ?>" on-value-changed="_onSearchValueChanged" value="{{searchValue}}">
				...
				<iron-pages selected="[[routeData.page]]" attr-for-selected="data-page" fallback-selection="index" role="main">
					...
					<?php
						...
						$section .= '<div data-page="404">' . PHP_EOL;
							$section .= '<article>' . PHP_EOL;
								$section .= '<p>' . __( 'Page not found', 'polyspa' ) . '</p>' . PHP_EOL;
							$section .= '</article>' . PHP_EOL;
						$section .= '</div>' . PHP_EOL;
